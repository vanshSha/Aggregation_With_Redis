...
@Component
public class TakeOffTimeProcessor {

    public TakeOffTimeEvent takeOffTimeEvent(TakeOffTimeEvent inComingEvent, TakeOffTimeEvent existingEvent) {
        ...
        if (existingEvent == null) {
            TakeOffTimeEvent newEvent = new TakeOffTimeEvent();
